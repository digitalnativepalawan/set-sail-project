...
export function buildTalaSystemPrompt(cms: CmsData, knowledge: TalaKnowledgeEntry[] = []): string {
  ...
  return cleanLines([
    ...
    "7. Be concise first; offer to go deeper rather than dumping everything.",
    "",
    "## Your tools",
    ...
    "- request_booking(guestName, roomType, checkIn, checkOut, guests?, amount?, notes?): call this when a guest wants to book. It creates a PENDING request the team confirms — never set it confirmed yourself.",
